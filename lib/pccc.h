 ...
 */
extern PCCC *pccc_new(uint8_t src_addr, unsigned int timeout,
		      size_t msgs);
extern PCCC_RET_T pccc_connect(PCCC *con, const char *link_host,
			       in_port_t link_port, const char *client_name);
 ...
 */
extern PCCC_RET_T pccc_cmd_Echo
(PCCC *con, UFUNC notify, uint8_t dnode, void *udata, size_t bytes);

extern PCCC_RET_T pccc_cmd_SetVariables
(PCCC *con, UFUNC notify, uint8_t dnode, uint8_t cycles, uint8_t naks,
 uint8_t acks);

extern PCCC_RET_T pccc_cmd_SetTimeout
(PCCC *con, UFUNC notify, uint8_t dnode, uint8_t cycles);

extern PCCC_RET_T pccc_cmd_SetNAKs
(PCCC *con, UFUNC notify, uint8_t dnode, uint8_t naks);

extern PCCC_RET_T pccc_cmd_SetENQs
(PCCC *con, UFUNC notify, uint8_t dnode, uint8_t enqs);

extern PCCC_RET_T pccc_cmd_ReadLinkParam
(PCCC *con, UFUNC notify, uint8_t dnode, uint8_t *udata);

extern PCCC_RET_T pccc_cmd_SetLinkParam
(PCCC *con, UFUNC notify, uint8_t dnode, uint8_t max);
